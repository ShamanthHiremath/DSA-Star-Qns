...
public:
    int eraseOverlapIntervals(vector<vector<int>>& intervals) {
        ...
        // inorder to remove the minimum Intervals u need to remove the bigger overalapping intervals, and keep the smaller ones to increase the size of the intervals VECTOR
